       ...
       while True:
        ...
        if choice == 'n':
          ...
          if args.isgray:
             ...
             imgR_o = cv2.cvtColor(cv2.imread(args.rightimg+str(index).zfill(6)+"_11.png",0), cv2.COLOR_GRAY2RGB)
          else:
             imgL_o = (skimage.io.imread(args.leftimg+str(index).zfill(6)+"_10.png").astype('float32'))
             imgR_o = (skimage.io.imread(args.rightimg+str(index).zfill(6)+"_11.png").astype('float32'))
